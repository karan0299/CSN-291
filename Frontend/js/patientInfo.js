    ...
    var MaterialCard = function (element, options) {
        ...
        if (that.card_activator == 'click') {
            ...
            this.button.on('click', function () {
                ...
                console.log($(element).children('.mc-btn-action').attr("id"))
                sessionStorage.PATIENTID = $(element).children('.mc-btn-action').attr("id")
                if(sessionStorage.getItem("TYPE")=="Doctor"){
                    window.location = `diagnosis.html`;
                }
                if(sessionStorage.getItem("TYPE")=="Pharmacist"){
                    window.location = 'sellMedicine.html';
                }
